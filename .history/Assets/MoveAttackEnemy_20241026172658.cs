...
public class MoveAttackEnemy : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        DownLeft = Camera.main.ScreenToWorldPoint(new Vector3(-Screen.width, -Screen.height,0)) - PlayerLenght;
        DownRight= Camera.main.ScreenToWorldPoint(new Vector3(Screen.width, -Screen.height,0)) - PlayerLenght;
    }
